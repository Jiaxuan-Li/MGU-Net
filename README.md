...
<br />&ensp;The labeled images are grayscale images. Labels and corresponding pixel values are as follows:
<br />&ensp;RNFL=26, GCL=51, IPL=77, INL=102, OPL=128, ONL=153, IS/OS=179, RPE=204, Choroid=230, Optic Disc=255
